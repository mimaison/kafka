...
object RequestConvertToJson {
  def request(request: AbstractRequest): JsonNode = {
    request match {
      ...
      case req: FindCoordinatorsRequest => FindCoordinatorsRequestDataJsonConverter.write(req.data, request.version)
  ...
  def response(response: AbstractResponse, version: Short): JsonNode = {
    response match {
      ...
      case res: FindCoordinatorsResponse => FindCoordinatorsResponseDataJsonConverter.write(res.data, version)
