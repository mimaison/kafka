 ...
 */
class MetadataCache(brokerId: Int, clusterId: String = "") extends Logging { //TODO MMEC no default clusterId
  ...
  def getClusterMetadata(listenerName: ListenerName): Cluster = {
    val snapshot = metadataSnapshot
