...
object KafkaConfig {
  ...
  val AcceptNewReplicasProp = "accept.new.replicas"
  /** ********* Controlled shutdown configuration ***********/
  ...
  val configDef = {
    ...
    new ConfigDef()
      ...
      .define(AcceptNewReplicasProp, BOOLEAN, Defaults.AcceptNewReplicas, MEDIUM, AcceptNewReplicasDoc)
